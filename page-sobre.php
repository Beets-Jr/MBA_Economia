...
?>
   ...
   <section class="admissao">
    <div class="admissao_descricao">
        <h2>Admissão</h2>
        <p>
            [Conheça as etapas do processo] Lorem ipsum dolor sit amet, 
            consectetur adipiscing elit. Pellentesque quis interdum dui.  
        </p>
    </div>
        ...
        <li>
            <div>
                ...
                <p>
                    ...
                    Pellentesque quis interdum dui. Nam hendrerit, dui id 
                    hendrerit dictum, odio sapien gravida magna, vel gravida
                    quam orci at turpis. Nunc vulputate nunc non imperdiet dapibus. 
                </p>
            </div>
        </li>
