...
?>
    ...
    <!-- Corpo Docente -->
     ...
     <div class="secao-historia">
        <div class="historia-wrapper">
            <div class="historia">
                 <h1><?php echo get_post_meta(get_the_ID(), 'titulo_conteudo1', true); ?></h1>
                 <div class="secao">
                    ...
                    <div class="secaotext">
                         <p><?php echo get_post_meta(get_the_ID(), 'texto_conteudo1', true); ?></p>
                     </div>
                </div>
             </div>
             <div class="UFSCar-Sorocaba">
                 <h1><?php echo get_post_meta(get_the_ID(), 'titulo_conteudo2', true); ?></h1>
                 <div class="secao">
               
                 
                     <div class="secaotext">
                         <p><?php echo get_post_meta(get_the_ID(), 'texto_conteudo2', true); ?></p>
                     </div>
                     <div class="secaoimagem">
            ...
            <div class="historia">
                <h1><?php echo get_post_meta(get_the_ID(), 'titulo_conteudo3', true); ?></h1>
                <div class="secao">
                   <div class="secaoimagem">
                   ...
                   <div class="secaotext">
                    <p><?php echo get_post_meta(get_the_ID(), 'texto_conteudo3', true); ?></p>
                 </div>
               </div>
            </div>
        </div>  
   ...
   <div class="secao-missao">
     <div class="missao">
        <h2><?php echo get_post_meta(get_the_ID(), 'titulo_card1', true); ?></h2>
        <div class="card-missao">
            <div class="missao-text">
                <p><?php echo get_post_meta(get_the_ID(), 'texto_card1', true); ?></p>
            </div>
     ...
     <div class="visao">
        <h2><?php echo get_post_meta(get_the_ID(), 'titulo_card2', true); ?></h2>
        <div class="card-missao">
            <div class="missao-text">
                <p><?php echo get_post_meta(get_the_ID(), 'texto_card2', true); ?></p>
            </div>
            <div class="missao-imagem">
