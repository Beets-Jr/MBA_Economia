...
?>
    ...
    <div class="ins-content">
        <div class="ins-initial-text">
            <p>O MBA Economia & Negócios é um curso de especialização lato sensu oferecido pelo Departamento de Economia da Universidade Federal de São Carlos (UFSCar) no campus Sorocaba, cidade localizada a cerca de 90 km de São Paulo.</p>
        </div>
